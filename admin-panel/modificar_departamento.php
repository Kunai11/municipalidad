  ...
  ?>
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-pencil-square-o""></i>Departamentos</h1>
            <p>Modificar departamento existente</p>
          </div>
          <div>
            <ul class="breadcrumb">
              ...
              <li>Departamentos</li>
              <li><a href="#">  Modificar departamento existente</a></li>
            </ul>
          </div>
        </div>
       ...
       <div class="col-md-6">
            <div class="departamento">
              <h3 class="card-title" align="center">Modificar datos de departamento</h3>
              <div class="card-body">
                <form class="form-horizontal">
                  <div class="form-group">
                    <label class="control-label col-md-3">Codigo de departamento</label>
                    <div class="col-md-8">
                      <input class="form-control" type="text" name="c_departameto" id="c_departameto" placeholder="Ingresar codigo de departameto a modificar" required>
                    </div>
                  </div>
                  <div class="form-group">
