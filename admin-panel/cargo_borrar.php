<?php
    ...
    if (isset($_SESSION['username'])&&($_SESSION['rank'])) {
        ...
        $queryVerificar = mysqli_query($db, "SELECT COUNT(*) as Existe FROM cargos WHERE Cod_Cargo='$codigo'") or die(mysqli_error());
        ...
        if ($rowExiste['Existe']==1) {
            ...
            $queryBorrar = mysqli_query($db, "DELETE FROM cargos WHERE Cod_Cargo='$codigo'") or die(mysqli_error());
