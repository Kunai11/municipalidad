    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-edit"></i> Modificar Planilla Existente</h1>
            <p>Modificar una planilla de pago existente</p>
          </div>
          <div>
            <ul class="breadcrumb">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <form class="form-horizontal" id="modificar_planilla">
                  <div class="form-group">
                        ...
                        <?php 
                          ...
                          while ($rowCargo=mysqli_fetch_array($queryListaCargos)) {
                            if ($rowCargo['Cod_Cargo']==$rowObjeto['Tipo']) {
                              echo '<option value="'.$rowCargo['Cod_Cargo'].'" selected>'.$rowCargo['Nom_Cargo'].'</option>';  
                            } 
                            if ($rowCargo['Cod_Cargo']!=$rowObjeto['Tipo']) {
              ...
              <div class="card-footer" align="center">
                <button class="btn btn-primary icon-btn" type="submit" form="modificar_planilla" id="modificar" name="modificar"><i class="fa fa-fw fa-lg fa-check-circle"></i>Modificar</button>
                &nbsp;&nbsp;&nbsp;
