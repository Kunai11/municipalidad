    ...
    <div class="wrapper">
            ...
            <ul class="treeview-menu">
              <li class="treeview"><a href="#"><i class="fa fa-group"></i><span>Empleados</span><i class="fa fa-angle-right"></i></a>
                <ul class="treeview-menu">
                  ...
                  <li><a href="modificar_empleado.php" target="_blank"><i class="fa fa-pencil-square-o"></i> Modificar existente</a></li>
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-pencil-square-o""></i>Empleados</h1>
            <p>Modificar empleado existente</p>
          </div>
          <div>
            <ul class="breadcrumb">
              ...
              <li>Empleados</li>
              <li><a href="#">  Modificar empleado existente</a></li>
            </ul>
          </div>
        </div>
              ...
              <div class="card-body">
                <form class="form-horizontal">
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <input class="form-control" type="text" name="m_identidad" id="m_identidad" placeholder="Ingresar numero de identidad a modificar" required>
                    </div>
                  </div>
                  <div class="form-group">
