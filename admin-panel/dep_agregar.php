      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            ...
            <p>Agregar un nuevo departamento</p>
          </div>
          <div>
            <ul class="breadcrumb">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                <form class="form-horizontal" id="guardar_depto">
                  <div class="form-group">
                    <label class="control-label col-md-3">Codigo de departamento</label>
                    <div class="col-md-8">
                      <input class="form-control" type="text" name="codigo_depto" id="codigo_depto" placeholder="Ingresar codigo de departamento">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <input class="form-control" type="text" name="nombre_depto" id="nombre_depto" placeholder="Ingresar nombre de departamento">
                    </div>
                  </div>
             ...
             <div class="card-footer" align="center">
                <button class="btn btn-primary icon-btn" type="submit" form="guardar_depto" id="agregar" name="agregar"><i class="fa fa-fw fa-lg fa-check-circle"></i>Guardar</button>
                &nbsp;&nbsp;&nbsp;
