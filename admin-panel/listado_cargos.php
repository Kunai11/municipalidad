    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-wpforms"></i> Listado de Cargos</h1>
            <ul class="breadcrumb side">
              <li><i class="fa fa-clipboard fa-lg"></i></li>
              <li class="active"><a href="#">Listado de Cargos</a></li>
            </ul>
          </div>
          <div><!--<a class="btn btn-primary btn-flat" href="#"><i class="fa fa-lg fa-plus"></i></a>--><a class="btn btn-info btn-flat no-impr" href="listado_cargos.php"><i class="fa fa-lg fa-refresh"></i></a><a class="btn btn-warning btn-flat" href="javascript:window.print();"><i class="fa fa-lg fa-print"></i></a></div>
        </div>
            ...
            <div class="card">
              <div class="card-body">
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
                    <?php
                      $queryFullCargos=mysqli_query($db, "SELECT * FROM cargos") or die(mysqli_error());
                      while ($rowCargo=mysqli_fetch_array($queryFullCargos)) {
                        echo '
                          <tr>
                            <td>'.$rowCargo['Cod_Cargo'].'</td>
